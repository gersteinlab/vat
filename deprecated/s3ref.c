...
static void put_object(int argc, char **argv, int optindex)
{
    ...
    *slash++ = 0;
    ...
    printf ("put_properties = {\n"
            ...
            "\tmetaData: %d\n"
            "}\n",
            (putProperties.contentType == NULL) ? "NULL" : putProperties.contentType,
            (putProperties.md5 == NULL) ? "NULL" : putProperties.md5,
            (putProperties.cacheControl == NULL) ? "NULL" : putProperties.cacheControl,
            (putProperties.contentDispositionFilename == NULL) ? "NULL" : putProperties.contentDispositionFilename,
            (putProperties.contentEncoding == NULL) ? "NULL" : putProperties.contentEncoding,
            putProperties.expires,
            (int) putProperties.cannedAcl,
            putProperties.metaDataCount,
            (putProperties.metaData == NULL));
